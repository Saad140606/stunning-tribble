...
import { listAdminComplaints, updateComplaint, bulkUpdateComplaints } from '../controllers/complaints.controller';
...
router.post('/complaints/bulk', bulkUpdateComplaints as any);
