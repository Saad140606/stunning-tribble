...
/**
 * Classifies an issue and extracts details using Google Gemini Flash API if available,
 * or falls back to a deterministic rule-based pattern matching system.
 */
...
Return a JSON object matching this schema:
{
  ...
  "estimatedResolutionTime": "e.g. 2-3 days"
      ...
      logger.error('Gemini API call failed, falling back to deterministic classifier:', err);
    }
  }
