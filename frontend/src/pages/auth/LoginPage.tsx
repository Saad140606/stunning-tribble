        ...
        <div className="z-10 my-auto max-w-lg space-y-6">
          ...
          >
            <h2 className="text-4xl lg:text-6xl font-black text-[#e8f4f8] leading-[1.1] tracking-tighter" style={{ fontFamily: "'Plus Jakarta Sans'" }}>
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-[#00d4ff] to-[#00ff94]">Fixing our city together.</span>
            </h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center lg:text-left">
            <div className="lg:hidden w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-6 bg-linear-to-br from-[#00d4ff] to-[#0088cc] shadow-[0_0_20px_rgba(0,212,255,0.3)]">
